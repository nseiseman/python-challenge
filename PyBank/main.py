...
print("----------")
print(f"Total Months: {total_months}") # Use f string to allow for variables or functions to be printed
print(f"Total Profit/Loss: ${total_profit_or_loss}") # Use curly brackets to insert the variables or formulas
print(f"Average Change: ${average_change:.2f}") # :.2f used to make value two decimal places
